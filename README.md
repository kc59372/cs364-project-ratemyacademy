...
I used ChatGPT as a supplemental debugging and design aid while refining the normalized review workflow, including diagnosing why initialized reviews displayed twice, reasoning through SERIAL IDs and seed data behavior, checking section seed inserts that use course lookups, and designing a database-driven section dropdown for the write-review form. I used the tool to review schema/query alignment, frontend dropdown population, /api/sections route behavior, and review submission flow; I made the actual implementation choices and code edits myself while using AI guidance to understand issues and verify the direction.
